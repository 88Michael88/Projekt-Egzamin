...
dziekan: dziekan.o sharedMemory.o semaphore.o messageQueue.o 
	$(CC) $(CFLAGS) -o $@ dziekan.o sharedMemory.o semaphore.o messageQueue.o
...
student: student.o sharedMemory.o semaphore.o messageQueue.o
	$(CC) $(CFLAGS) -o $@ student.o sharedMemory.o semaphore.o messageQueue.o

# Compile uczen
uczen: uczen.o sharedMemory.o semaphore.o messageQueue.o
	$(CC) $(CFLAGS) -o $@ uczen.o sharedMemory.o semaphore.o messageQueue.o
